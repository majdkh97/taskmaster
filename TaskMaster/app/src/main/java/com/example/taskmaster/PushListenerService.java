...
public class PushListenerService extends FirebaseMessagingService {
    ...
    public void onNewToken(@NonNull @NotNull String s) {
        SignIn.getPinpointManager(getApplicationContext()).getNotificationClient().registerDeviceToken(s);
    }
    ...
    public void onMessageReceived(@NonNull @NotNull RemoteMessage remoteMessage) {
        ...
        Log.i("message received", "test test");
        final NotificationClient notificationClient = SignIn.getPinpointManager(getApplicationContext()).getNotificationClient();
